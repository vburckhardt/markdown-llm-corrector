...
- VPC load balancers for the instances
...
Virtual private endpoints can be created for any number of services. The components for virtual private endpoints are defined in the [vpe.tf](vpe.tf) file.
